...
repl: $(BINDIR)
	$(CC) $(CFLAGS) src/repl.c $(addprefix src/, eval.c parser.c env.c lexer.c token.c object.c mem.c) -ledit -Ofast -o $(BINDIR)/repl

monkey: $(BINDIR)
	$(CC) $(CFLAGS) src/monkey.c $(addprefix src/, eval.c parser.c env.c lexer.c token.c object.c mem.c) -Ofast --optimize -o $(BINDIR)/monkey 
...
eval_test:
	$(CC) $(TESTFLAGS) src/eval_test.c $(addprefix src/, eval.c parser.c env.c lexer.c token.c object.c mem.c) -o $(BINDIR)/eval_test
	$(BINDIR)/eval_test
